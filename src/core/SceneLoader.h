...
private:
    ...
    static std::shared_ptr<SceneNode> LoadSceneNode(
    ...
    static std::unique_ptr<Material> LoadMaterial(const aiMaterial* pAiMaterial,
    ...
    static std::vector<std::shared_ptr<Mesh>> LoadMeshes(
    ...
    static std::unique_ptr<Mesh> LoadMesh(
    ...
    static void ShowTextureInformation(const aiMaterial* pMaterial, aiTextureType pType,
