...
const std::vector<float>& Geometry::GetVerticesData() const { return mVertexData; }

unsigned int Geometry::GetVertexStride() const { return mVertexStride; }
...
const std::vector<unsigned int>& Geometry::GetIndexsData() const { return mIndexData; }

void Geometry::SetName(const std::string& pName) { mName = pName; }
...
std::shared_ptr<AxisAlignedBoundingBox> Geometry::GetBoundingBox() const { return mBoundingBox; }

std::shared_ptr<BoundingSphere> Geometry::GetBoundingSphere() const { return mBoundingSphere; }

void Geometry::Draw() { GetGPUGeometry()->Draw(); }

size_t Geometry::GetNumIndices() const { return mIndexData.size(); }
...
size_t Geometry::GetNumVertices() const { return mVertexData.size() / mVertexStride; }

GeometryTopology Geometry::GetTopology() const { return mTopology; }
