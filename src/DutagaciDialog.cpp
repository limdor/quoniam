...
DutagaciDialog::~DutagaciDialog() { delete mUi; }

std::vector<QString> DutagaciDialog::GetFilesToLoad() const { return mFilesToLoad; }

float DutagaciDialog::GetDistance() const { return mDistance; }

int DutagaciDialog::GetAngle() const { return mAngle; }
